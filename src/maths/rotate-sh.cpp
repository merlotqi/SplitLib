...
constexpr float kSqrt03_02 = 1.224744871391589;    // sqrt(3/2)
constexpr float kSqrt01_03 = 0.5773502691896258;   // sqrt(1/3)
constexpr float kSqrt02_03 = 0.816496580927726;    // sqrt(2/3)
constexpr float kSqrt04_03 = 1.154700538379252;    // sqrt(4/3)
constexpr float kSqrt01_04 = 0.5;                  // sqrt(1/4)
constexpr float kSqrt03_04 = 0.8660254037844386;   // sqrt(3/4)
constexpr float kSqrt01_05 = 0.4472135954999579;   // sqrt(1/5)
constexpr float kSqrt03_05 = 0.7745966692414834;   // sqrt(3/5)
constexpr float kSqrt06_05 = 1.095445115010332;    // sqrt(6/5)
constexpr float kSqrt08_05 = 1.2649110640673518;   // sqrt(8/5)
constexpr float kSqrt09_05 = 1.341640786499874;    // sqrt(9/5)
constexpr float kSqrt01_06 = 0.408248290463863;    // sqrt(1/6)
constexpr float kSqrt05_06 = 0.912870929175277;    // sqrt(5/6)
constexpr float kSqrt03_08 = 0.6123724356957945;   // sqrt(3/8)
constexpr float kSqrt05_08 = 0.7905694150420949;   // sqrt(5/8)
constexpr float kSqrt09_08 = 1.0606601717798214;   // sqrt(9/8)
constexpr float kSqrt05_09 = 0.7453559924999299;   // sqrt(5/9)
constexpr float kSqrt08_09 = 0.9428090415820634;   // sqrt(8/9)
constexpr float kSqrt01_10 = 0.31622776601683794;  // sqrt(1/10)
constexpr float kSqrt03_10 = 0.5477225575051661;   // sqrt(3/10)
constexpr float kSqrt01_12 = 0.2886751345948129;   // sqrt(1/12)
constexpr float kSqrt04_15 = 0.5163977794943222;   // sqrt(4/15)
constexpr float kSqrt01_16 = 0.25;                 // sqrt(1/16)
constexpr float kSqrt15_16 = 0.9682458365518543;   // sqrt(15/16)
constexpr float kSqrt01_18 = 0.2357022603955158;   // sqrt(1/18)
constexpr float kSqrt01_60 = 0.1290994448735806;   // sqrt(1/60)
